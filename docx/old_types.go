...
type Document struct {
    ...
    XMLNsR      string   `xml:"r,attr,omitempty"`
...
// XMLMargins - margins значение
type XMLMargins struct {
    Top XMLWidthValue `xml:"top"`    
    Left XMLWidthValue `xml:"left"`
    Bottom XMLWidthValue `xml:"bottom"`
    Right XMLWidthValue `xml:"right"`
}
